...
for query in queries:
    controller_results_1 = search_and_store_results(query, "Profile 1")
    tester_results_1 = search_and_store_results(query, "Profile 2")
    for mod in moderators:
        search_and_store_results(mod, "Profile 2")
    controller_results_2 = search_and_store_results(query, "Profile 1")
    tester_results_2 = search_and_store_results(query, "Profile 2")
    results = {}
